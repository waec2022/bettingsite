...
(function () {
  ...
  /* =======================================================
     2. SITE DATA — edit predictions, accumulators, results,
     news, etc. directly here. This is the active data source.
     ======================================================= */
  ...
  var SITE_DATA = {
    ...
    predictions: [
      { id: 1, match: "Sweden vs Man City", pick: "Over 4.5 Goals", odds: 5.45, bookmakers: ["bet9ja", "sportybet"], code: "BJ-4821-AC", category: "Over/Under" },
    ...
    accumulators: [
      { key: "4", odds: "4 Odds", matchIds: [1, 2, 6,10], themeClass: "accumulator-card--3" },
